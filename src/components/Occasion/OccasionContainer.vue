<template>
  <div class="occasion-container">
      <div class="grid-layout">
          <div style="display:inline;" v-bind:key="occasionItem.id" v-for="occasionItem in occasionItems">  
...
<script>
// @ is an alias to /src
import OccasionItem from './OccasionItem.vue'
import axios from 'axios'


export default {
  name: 'OccasionContainer',
  components: {
    OccasionItem
  },
  data() {
  ...
  async created(){
      try {
          let res = await axios.get('http://localhost:3000/getHouses')
